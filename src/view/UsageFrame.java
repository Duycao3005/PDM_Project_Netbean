...
public class UsageFrame extends javax.swing.JFrame {
    ...
    public UsageFrame() {
        ...
        defaultTableModel.addColumn("Mã sử dụng");
        defaultTableModel.addColumn("Mã đồng hồ");
        defaultTableModel.addColumn("Ngày ghi");
        defaultTableModel.addColumn("Chỉ số cũ");
        defaultTableModel.addColumn("Chỉ số mới");
        defaultTableModel.addColumn("Tiêu thụ");
