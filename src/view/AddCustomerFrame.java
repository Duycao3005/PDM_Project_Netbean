 ...
 * @author ThinkPad
 */
public class AddCustomerFrame extends javax.swing.JDialog {
     ...
     */
    public AddCustomerFrame(java.awt.Frame parent, boolean modal) {
       super(parent, modal); 
    initComponents();
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        try {
            // 1. Lấy dữ liệu từ các ô nhập trên màn hình
            String name = jTextField1.getText(); // Thay txtName bằng tên biến JTextField của bạn
            ...
            // Kiểm tra xem tên có bị bỏ trống không (Vì trong 1.sql name là NOT NULL)
            if (name.trim().isEmpty()) {
                javax.swing.JOptionPane.showMessageDialog(this, "Name Customer can not empty!");
                return; // Dừng lại không chạy tiếp
            }
            // Kiểm tra xem đã chọn loại khách hàng chưa
            if (type.isEmpty()) {
                javax.swing.JOptionPane.showMessageDialog(this, "Please select your customer type!");
                return;
            }
            // 2. Đóng gói dữ liệu vào Object Customer 
            // (Không cần set ID vì database tự động tăng AUTO_INCREMENT)
